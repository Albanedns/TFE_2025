                ...
                if participant_id in labels_dict.keys() and not training_block:
                    ...
                    for trial in unique_trials:
                        if( tree_count_dict[(participant_id, block_number, int(trial))]==1):
                            ...
                            if trial_phases == expected_phases:
                                ...
                                if(trial_data.shape[0]>0):
                                    prob_augment = 0.4 # probalibilité de data augmentation (à modifier comme souhaité)
...
label_file = "errors.csv"  # chemin du fichier excel contenant les labels
